...
+ Press `Ctrl + Shift + P` or `Shift + ⌘ + P` as mentioned, type `Reload Custom CSS and JS` to activate the command.
+ And then close all the windows again, restart VSCode normally.
